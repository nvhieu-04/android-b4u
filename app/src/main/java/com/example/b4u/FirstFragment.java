...
public class FirstFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        careProductList.add(new CareProduct("Butter Gloss, Non-Sticky Lip Gloss - Tiramisu","NYX","114.223đ","Butter Gloss: Buttery soft and silky smooth, our decadent Butter Gloss is available in a wide variety of sumptuous shades; Each glossy color delivers sheer to medium coverage that melts onto your lips","4.4/5 (5103 đánh giá)",R.drawable.product_15,R.drawable.product_15));
        careProductList.add(new CareProduct("Original Volume Building Mascara, Carbon Black","L’Oreal Paris","312.500đ","Voluminous Mascara is uniquely formulated to resist clumping, soften and build lashes up to 5X their natural thickness; The Volume Maximizing Brush thickens lashes evenly and smoothly; Suitable for sensitive eyes and contact lens wearers","4.7/5 (3000 đánh giá)",R.drawable.product_16,R.drawable.product_16));
        ...
        careProductList.add(new CareProduct("Lash Blast Volume Mascara, Brown","Cover Girl","142.491đ","Designed to max out every lash, Lash Blast Volume Mascara creates ten times more volume instantly. Instant blast of fullness and length.","4.4/5 (4506 đánh giá)",R.drawable.product_19,R.drawable.product_19));
        ...
        careProductList.add(new CareProduct("Photo Focus Foundation, Soft Beige","wet n wild","62.512đ","Our high-performing, skin-perfecting foundation is formulated with a matte, light-diffusing complex to help prevent white cast in photos & deliver a radiant-looking complexion.","4.8 (4826 đánh giá)",R.drawable.product_22,R.drawable.product_22));
        //
        ...
        productList.add(new Product("Four-way shadow palette","Haus Laboratories","579.111đ","Bring your desire out of the shadows with a new kind of FOUR-WAY. Each quad was curated to unlock allure with a range of 4 blendable finishes + colors reminiscent of the escapes they're named for. Take each shadow for a spin solo, or finish strong by fornicating together. Whatever your fantasy, play freely.","4.5/5 (2103 đánh giá)",R.drawable.product_2,R.drawable.product_2));
        productList.add(new Product("La luce lip glaze","Haus Laboratories","627.370đ","Transform your pout with a high shine, multi-dimensional glaze topper that plumps & moisturizes.","4/5 (6921 đánh giá)",R.drawable.product_3,R.drawable.product_3));
        productList.add(new Product("Glam attack metallic crème","Haus Laboratories","627.370đ","Transform your pout with a high shine, multi-dimensional glaze topper that plumps & moisturizes.","4.8/5 (7215 đánh giá)",R.drawable.product_4,R.drawable.product_4));
        productList.add(new Product("PhD hybrid lip oil","Haus Laboratories","450.000đ","From our labs to your lips: PhD HYBRID LIP OIL is a transformative, ultra-hydrating sheer lip oil that melts down into a true-to-you lip tint, powered by your own pH + plant-based ingredients. Named a 2021 PopSugar Pick.","4.9/5 (1028 đánh giá)",R.drawable.product_5,R.drawable.product_5));
        productList.add(new Product("LOVE FOR SALE SHADOW PALETTE","Haus Laboratories","1103.160đ","The most anticipated palette of the season is here. HAUS LABS proudly presents LOVE FOR SALE — a new + limited edition shadow palette featuring 18 high performance, soul-stirring shades in a range of velvety mattes, lustrous shimmers, multidimensional metallics and an all-over sparkle topper – inviting you to get back to glam with our most innovative formulas yet.","4.6/5 (2201 đánh giá)",R.drawable.product_1,R.drawable.product_1));
        productList.add(new Product("LE RIOT LIP GLOSS-Plaze","Haus Laboratories","413.685đ","This extreme high-shine gel gloss amplifies any look. Comfortable enough to not weigh you down, reflective enough to celebrate yourself with a shimmer, sparkle or true shine finish.","4.4/5 (4136 đánh giá)",R.drawable.product_6,R.drawable.product_6));
        ...
        productList.add(new Product("Butter Gloss, Non-Sticky Lip Gloss - Tiramisu","NYX","114.223đ","Butter Gloss: Buttery soft and silky smooth, our decadent Butter Gloss is available in a wide variety of sumptuous shades; Each glossy color delivers sheer to medium coverage that melts onto your lips","4.4/5 (5103 đánh giá)",R.drawable.product_15,R.drawable.product_15));
        productList.add(new Product("Original Volume Building Mascara, Carbon Black","L’Oreal Paris","312.500đ","Voluminous Mascara is uniquely formulated to resist clumping, soften and build lashes up to 5X their natural thickness; The Volume Maximizing Brush thickens lashes evenly and smoothly; Suitable for sensitive eyes and contact lens wearers","4.9 (3000 đánh giá)",R.drawable.product_16,R.drawable.product_16));
        productList.add(new Product("WALNUT FACE SCRUB","Kylie Skin","505.615đ","Gently exfoliates, helps remove dead skin cells and refine skins texture. Walnut Powder and a Botanical Blend of Fruit Extracts: Help to gently smooth skin. Squalane and Sodium Hyaluronate: Moisturizing agents that help reinforce the skin’s natural moisture.","4/5 (2103 đánh giá)",R.drawable.product_11,R.drawable.product_11));
        productList.add(new Product("Lash Blast Volume Mascara, Brown","Cover Girl","142.491đ","Designed to max out every lash, Lash Blast Volume Mascara creates ten times more volume instantly. Instant blast of fullness and length.","4/5 (4506 đánh giá)",R.drawable.product_19,R.drawable.product_19));
        productList.add(new Product("TruBlend Matte Made Liquid Foundation, Sun Beige","Cover Girl","144.789đ","Comfortable matte foundation gives you that flawless-looking finish. Mattifying powders absorb excess oil and minimize the appearance of your pores for a smooth, polished look.","4.5/5 (2901 đánh giá)",R.drawable.product_20,R.drawable.product_20));
        productList.add(new Product("Rimmel Stay Matte Foundation Soft Beige","Rimmel Store","54.238đ","Stay matte, stop shine: This liquid mousse blends flawlessly to even out skin tone and stop shine for hours; With a natural looking yet photo ready finish, your face will look practically poreless and baby soft all day long; Prepare for matte perfection.","4.7/5 (4403 đánh giá)",R.drawable.product_21,R.drawable.product_21));
        productList.add(new Product("Photo Focus Foundation, Soft Beige","wet n wild","62.512đ","Our high-performing, skin-perfecting foundation is formulated with a matte, light-diffusing complex to help prevent white cast in photos & deliver a radiant-looking complexion.","4/5 (4826 đánh giá)",R.drawable.product_22,R.drawable.product_22));
