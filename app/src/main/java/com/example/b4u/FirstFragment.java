...
public class FirstFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        productList.add(new Product("Love for sale shadow palette","Description","Price","10","5/5",R.drawable.product_1));
        productList.add(new Product("Four-way shadow palette","Description","Price","10","5/5",R.drawable.product_2));
        productList.add(new Product("La luce lip glaze","Description","Price","10","5/5",R.drawable.product_3));
        productList.add(new Product("Glam attack metallic crème","Description","12$","10","5/5",R.drawable.product_4));
        productList.add(new Product("PhD hybrid lip oil","Description","Price","10","5/5",R.drawable.product_5));
        productList.add(new Product("Le riot lip gloss","Description","Price","10","5/5",R.drawable.product_6));
