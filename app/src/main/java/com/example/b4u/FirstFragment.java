...
public class FirstFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        productList.add(new Product("Lash Blast Volume Mascara, Brown","Cover Girl","142,491đ","Designed to max out every lash, Lash Blast Volume Mascara creates ten times more volume instantly. Instant blast of fullness and length.","4506",R.drawable.product_19,R.drawable.product_19));
        ...
        productList.add(new Product("Photo Focus Foundation, Soft Beige","wet n wild","62,512đ","Our high-performing, skin-perfecting foundation is formulated with a matte, light-diffusing complex to help prevent white cast in photos & deliver a radiant-looking complexion.","4826",R.drawable.product_22,R.drawable.product_22));
