...
public class FirstFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        careProductList.add(new CareProduct("Original Volume Building Mascara, Carbon Black","L’Oreal Paris","312.500","Voluminous Mascara is uniquely formulated to resist clumping, soften and build lashes up to 5X their natural thickness; The Volume Maximizing Brush thickens lashes evenly and smoothly; Suitable for sensitive eyes and contact lens wearers","3000",R.drawable.product_16,R.drawable.product_16));
        ...
        careProductList.add(new CareProduct("Lash Blast Volume Mascara, Brown","Cover Girl","142.491","Designed to max out every lash, Lash Blast Volume Mascara creates ten times more volume instantly. Instant blast of fullness and length.","4506",R.drawable.product_19,R.drawable.product_19));
        ...
        careProductList.add(new CareProduct("Photo Focus Foundation, Soft Beige","wet n wild","62.512","Our high-performing, skin-perfecting foundation is formulated with a matte, light-diffusing complex to help prevent white cast in photos & deliver a radiant-looking complexion.","4826",R.drawable.product_22,R.drawable.product_22));
        //
        ...
        productList.add(new Product("LOVE FOR SALE SHADOW PALETTE","Haus Laboratories","1103.160","The most anticipated palette of the season is here. HAUS LABS proudly presents LOVE FOR SALE — a new + limited edition shadow palette featuring 18 high performance, soul-stirring shades in a range of velvety mattes, lustrous shimmers, multidimensional metallics and an all-over sparkle topper – inviting you to get back to glam with our most innovative formulas yet.","4.6/5 (2201 đánh giá)",R.drawable.product_1,R.drawable.product_1));
